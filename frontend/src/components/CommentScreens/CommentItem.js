            ...
            <div className="comment-bottom-block">
                ...
                <div className="commentLike-wrapper">
                    ...
                    <i className='biLike' onClick={() => handleCommentLike()}>
                        {
                            likeStatus ? <MdWavingHand style={{color:"black"}} /> : <MdOutlineWavingHand style={{color:"grey"}} />

                        }
                    </i>
                    <span className='commentlikeCount' style={likeCount>0 ?{color:"black"}:{color:"grey"}}>
                        {likeCount}
                        ...
                        [...Array(5)].map((_, index) => {
                            return (
                                <FaStar
                                    ...
                                    className="star"
                                    size={15}
                                    color={comment.star > index ? "#ed813a" : "grey"}
                                />
                            )
                        })
                    }
