                  ...
                  <ul>
                    <li>
                      ...
                      <i onClick={handleLike} >
                        ...
                        {likeStatus ? <FaHeart color="rgb(183, 21, 21)" /> :
                          <FaRegHeart />
                        }
                      </i>

                      <b className='likecount'
                        style={likeStatus ? { color: "black" } : { color: "grey" }}
                      >  {likeCount}
                      </b>
                    ...
                    <li>
                      ...
                      {
                        story.commentCount>0 ? <FaComment color='black'/>:
                        <FaComment style={{color:"grey"}} />
                      }
                      </i>

                      <b style={story.commentCount>0 ? {color:"black"}:{color:'gray'}}>{story.commentCount}</b>
                  ...
                  <ul>
                    <li>
                      <i onClick={addStoryToReadList}>
                        ...
                        {storyReadListStatus ? <BsBookmarkFill color='black' /> :
                          <BsBookmarkPlus />
                        }
                      </i>
                    </li>
